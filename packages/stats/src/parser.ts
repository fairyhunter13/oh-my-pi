...
/**
 * List all session files in a folder, in name order. A session file is named
 * `<ISO timestamp>_<id>.jsonl`, so a fork sorts after its parent and the parent
 * keeps the rows the fork copied.
 */
